...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        if (SELECT == setViewElements()) {
            Log.i(TAG, setViewElements())
            textAction.text = "Click to juice the lemon!"
            lemonImage!!.setImageResource(R.drawable.lemon_squeeze)

        } else if (SQUEEZE == setViewElements()) {
        ...
        } else if (DRINK == setViewElements()) {
            lemonadeState = RESTART

            textAction.text = "Click to start again!"
            lemonImage!!.setImageResource(R.drawable.lemon_restart)

        } else if (RESTART == setViewElements()) {
     ...
     */
    private fun setViewElements(): String {
        val textAction: TextView = findViewById(R.id.text_action)
        ...
        val lemonSelect     = R.string.lemon_select
        val lemonSqueeze    = R.string.lemon_squeeze
        val lemonDrink      = R.string.lemon_drink
        val lemonEmptyGlass = R.string.lemon_empty_glass
        // Don´t Work ^^


        var result = when (textAction.text) {
            "Click to select a lemon!"      -> SELECT
            "Click to juice the lemon!"     -> SQUEEZE
            "Click to drink your lemonade!" -> DRINK
            "Click to start again!"         -> RESTART
            else -> {
                "default"
            }
        }
